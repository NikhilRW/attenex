...
module.exports = {
  ...
  apps: {
    ...
    "android.release": {
      ...
      build:
        "cd android && gradlew assembleRelease assembleAndroidTest -DtestBuildType=release -Pandroid.enableMinifyInReleaseBuilds=false -Pandroid.enableShrinkResourcesInReleaseBuilds=false",
    },
  },
  devices: {
    simulator: {
