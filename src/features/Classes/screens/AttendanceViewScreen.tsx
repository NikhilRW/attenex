          ...
          <View style={styles.listContainer}>
            {filteredAttendance.length === 0 ? (
              ...
              >
                ...
                />
                <Text
                  style={[styles.emptyStateText, { color: colors.text.muted }]}
                >
                  No students found
                </Text>
              </Animated.View>
                  ...
                  <View style={styles.cardContent}>
                    ...
                    <View style={styles.statusContainer}>
                      {record.status === "present" ? (
                        ...
                        >
                          <Text
                            style={[styles.absentText, { color: "#FBBF24" }]}
                          >
                            INC
                          </Text>
                        </View>
                        ...
                        >
                          <Text
                            style={[styles.absentText, { color: "#F87171" }]}
                          >
                            ABS
                          </Text>
                        </View>
          ...
          >
            ...
            >
              <View style={styles.modalHeader}>
                ...
                <TouchableOpacity
                  onPress={() => setShowRollSummary(false)}
                  style={[
                    styles.closeButton,
                    {
                      backgroundColor: isDark
          ...
          >
            ...
            >
              <View style={styles.modalHeader}>
                ...
                <TouchableOpacity
                  onPress={() => setShowManualAttendance(false)}
                  style={[
                    styles.closeButton,
                    {
                      backgroundColor: isDark
